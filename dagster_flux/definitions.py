...
import os
from dagster_flux.jobs import news_processing_job, ranking_job, mark_matches_finished_job
from dagster_flux.sensors import news_sensor_factory, matches_sensor_factory, rank_when_many_news, mark_matches_finished
...
defs = Definitions(
    ...
    resources={
        "kafka": KafkaResource(
            bootstrap_servers=[os.getenv("KAFKA_BOOTSTRAP_SERVER_DOCKER", "localhost:19092")],
            topics=topics
        )
    },
)
